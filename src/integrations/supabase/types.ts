  ...
  public: {
    Tables: {
      ...
      hosting_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "hosting_payments_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "hosting_payments_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
    ...
    Enums: {
      app_role: "admin" | "membro" | "pendente"
      payment_status: "pago" | "pendente" | "devendo" | "parcial"
    }
    CompositeTypes: {
      [_ in never]: never
    }
